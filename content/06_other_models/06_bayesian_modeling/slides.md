...
<!--
This unit is about an algorithm called "Naive Bayes," which is named for the famous statistician Thomas Bayes. The algorithm is built upon Bayes' theorem, and it is one of the most popular classifier algorithms, especially for spam detection and filtering.
...
* Image name: res/no_spam.png
  * Repo link: https://github.com/google/applied-machine-learning-intensive/blob/master/content/06_other_models/06_bayesian_modeling/res/no_spam.png
  * Source https://pixabay.com/vectors/email-mail-spam-message-e-mail-29853/ by Author Clker-Free-Vector-Images https://pixabay.com/users/clker-free-vector-images-3736/ under License https://pixabay.com/service/license/.
-->
...
* Image name: res/sorting_eggs.jpeg
  * Repo link: https://github.com/google/applied-machine-learning-intensive/blob/master/content/06_other_models/06_bayesian_modeling/res/sorting_eggs.jpeg
  * Source https://unsplash.com/photos/BiZ-_6kNjbI by Author Sophie Elvis https://unsplash.com/@thetechnomaid under License https://unsplash.com/license.
-->
