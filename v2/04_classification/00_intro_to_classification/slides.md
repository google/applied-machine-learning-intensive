...
<!---
We are now shifting our focus away from regression and onto another application of machine learning: classification.
-->
...
@Exercise (10 minutes) {
Ask the students to calculate the accuracy, precision, recall, and F1 scores. The answers will be presented in the following slides.
}
